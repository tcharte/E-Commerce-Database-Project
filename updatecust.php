...
if(isset($_POST['firstName']) && isset($_POST['lastName']) && isset($_POST['email']) && isset($_POST['phonenum']) && isset($_POST['address']) && isset($_POST['city']) && isset($_POST['state']) && isset($_POST['postalCode']) && isset($_POST['country']) && isset($_POST['userid']) && isset($_POST['pass'])){
    ...
    $sql = "UPDATE customer 
			SET firstName = " . $firstName . ", lastName = " . $lastName . ", email = " . $email . ", phonenum = " .$phonenum . ", address = " . $address . ", city = " . $city . ", state = " . $state . ", postalCode = " . $postalCode . ", country = " . $country . ", userid = " . $userid . ", password = " . $password ."
			WHERE customerId = " . $customerId;
			
			
			
			//(firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password) VALUES ('" . $firstName . "', '" . $lastName . "', '" . $email . "', '" . $phonenum . "', '" . $address ."', '" . $city . "', '" . $state . "', '" . $postalCode . "', '" . $country . "', '" . $userid . "' , '" . $pass . "')";
